 ...
 */
package com.topxgun.appbase.component.nineoldanim.animation;
...
public class AnimatorInflater {
    ...
    /**
     * Loads an {@link com.topxgun.appbase.component.nineoldanim.animation.Animator} object from a resource
     *
     ...
     */
    public static com.topxgun.appbase.component.nineoldanim.animation.Animator loadAnimator(Context context, int id)
    ...
    private static com.topxgun.appbase.component.nineoldanim.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser)
    ...
    private static com.topxgun.appbase.component.nineoldanim.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser,
                                                                                            AttributeSet attrs, com.topxgun.appbase.component.nineoldanim.animation.AnimatorSet parent, int sequenceOrdering)
            throws XmlPullParserException, IOException {

        com.topxgun.appbase.component.nineoldanim.animation.Animator anim = null;
        ArrayList<com.topxgun.appbase.component.nineoldanim.animation.Animator> childAnims = null;
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                createAnimatorFromXml(c, parser, attrs, (com.topxgun.appbase.component.nineoldanim.animation.AnimatorSet) anim,  ordering);
                a.recycle();
            } else {
            ...
            if (parent != null) {
                if (childAnims == null) {
                    childAnims = new ArrayList<com.topxgun.appbase.component.nineoldanim.animation.Animator>();
                }
                childAnims.add(anim);
            }
        }
        if (parent != null && childAnims != null) {
            com.topxgun.appbase.component.nineoldanim.animation.Animator[] animsArray = new Animator[childAnims.size()];
            int index = 0;
            for (com.topxgun.appbase.component.nineoldanim.animation.Animator a : childAnims) {
                animsArray[index++] = a;
            }
