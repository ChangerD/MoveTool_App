 ...
 */
public class MarginRightAttr extends com.topxgun.appbase.component.autolayout.attr.AutoAttr
{
    ...
    {
        return com.topxgun.appbase.component.autolayout.attr.Attrs.MARGIN_RIGHT;
    }
    ...
    public static MarginRightAttr generate(int val, int baseFlag)
    {
        ...
        switch (baseFlag)
        {
            case com.topxgun.appbase.component.autolayout.attr.AutoAttr.BASE_WIDTH:
                attr = new MarginRightAttr(val, com.topxgun.appbase.component.autolayout.attr.Attrs.MARGIN_RIGHT, 0);
                break;
            case com.topxgun.appbase.component.autolayout.attr.AutoAttr.BASE_HEIGHT:
                attr = new MarginRightAttr(val, 0, com.topxgun.appbase.component.autolayout.attr.Attrs.MARGIN_RIGHT);
                break;
